export const mockOverviewData = {
  marketVitals: [
    { label: 'SOL Price', value: '$145.80', change: '+2.5%', changeType: 'positive' as const },
    { label: 'Solana Market Cap', value: '$67.2B', change: '+3.1%', changeType: 'positive' as const },
    { label: '24h Volume (All DEXes)', value: '$2.1B', change: '-5.7%', changeType: 'negative' as const },
    { label: 'Network TPS', value: '2,890', change: '+1.2%', changeType: 'positive' as const },
    { label: 'AKG Sentiment Index', value: '72', subValue: 'Bullish', changeType: 'positive' as const },
  ],
  hotContracts: [
  ...
  derivativesSummary: [
    { label: 'Total Open Interest', value: '$1.5B', change: '+8.2%', changeType: 'positive' as const },
    { label: 'Avg. Funding Rate', value: '-0.015%', change: 'Shorts Paying', changeType: 'negative' as const },
    { label: '24h Liquidations', value: '$25.6M', subValue: 'Longs: $18M', changeType: 'negative' as const },
    { label: 'Top Perp Exchange', value: 'Drift', subValue: '$500M Volume' },
  ]
};